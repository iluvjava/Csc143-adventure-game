...
public class AdvMotionCommand extends AdvCommand {
	...
	// testing...
	public static boolean SG_testing  = false;public static void println(String s){if(AdvMotionCommand.SG_testing)System.out.println(s);}
 ...
 */
	...
	{
		println("AdvmotionCommand constructed: "+ dir);
		direction = dir;
	}
 ...
 */
	...
	{
		println("AdvmotionCommand: " +this.direction+" Object: "+obj);
