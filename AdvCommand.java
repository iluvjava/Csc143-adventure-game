...
public abstract class AdvCommand {
	...
	public static boolean SG_testing = false;
	...
	{
		if(AdvCommand.SG_testing)System.out.println(s);
	}
...
class QuitCommand extends AdvCommand {
	...
	{
		println("Executing quitecommand... ");
...
/**
 *This is the method that will got executed when the user input the 
 *and ask for the description of the room. And each time the adventure 
 *enter a new room, it will execute this command whatsoever if the room is 
 *not visited. 
 */
...
class TakeCommand extends AdvCommand {
	public void execute(Adventure game, AdvObject obj) {
		println("Executing take coammnd...");
...
class DropCommand extends AdvCommand {
	public void execute(Adventure game, AdvObject obj) {
		println("kExecuting look command...");
...
class HelpCommand extends AdvCommand {
	public void execute(Adventure game, AdvObject obj) 
	{
		System.out.println("If  you think the game is too hard, just type quit(q) and the game will exist. ");
